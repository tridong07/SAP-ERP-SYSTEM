...
import { Trash2, Plus, Info, Save, GripVertical } from "lucide-react";

export default function WorkflowPanel({ template, onClose, isOpen }: any) {
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      {/* Footer cố định của Panel */}
      <div className="pt-6 border-t bg-white flex gap-3">
